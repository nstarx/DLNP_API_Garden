// Mock data for Video to Text application
...
export const mockRecentActivity = [
    ...
    {
        id: 2,
        title: 'MP4 file uploaded',
        time: '15 minutes ago',
        status: 'processing',
        icon: 'pi pi-clock',
        details: 'Meeting_Recording_2024.mp4',
        source: 'local_file',
        duration: '32:18',
        fileSize: '128.7 MB'
    },
    {
        ...
        status: 'completed',
        icon: 'pi pi-language',
        details: 'Product Demo - English to Spanish',
    ...
    },
    {
        ...
        details: 'Tech_Talk_Episode_42.mp3',
        source: 'local_file',
        duration: '58:12',
        fileSize: '89.4 MB',
...
export const mockTips = [
    ...
    },
    {
        ...
        text: 'Processing time depends on video length and selected model'
    },
    {
        icon: 'pi pi-file',
        color: 'text-green-500',
        text: 'Supported formats: MP4, AVI, MOV, YouTube URLs'
    }
];
